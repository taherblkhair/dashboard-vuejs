...
const routes = [
  ...
  { path: 'purchases/orders/:id/edit', name: 'PurchaseOrderEdit', component: () => import('../views/Purchases/PurchaseOrderEdit.vue') },
  ...
  { path: 'deliveries', name: 'Deliveries', component: () => import('../views/Deliveries/index.vue') },
  { path: 'deliveries/:id', name: 'DeliveryDetails', component: () => import('../views/Deliveries/Details.vue') },
